            ...
            for state in range(self.state_dim):
                ...
                for action in range(self.action_dim):
                    ...
                    for s_prime in range(self.state_dim):
                        transition_prob = self.mdp.P[state, action, s_prime]
                        reward = self.mdp.R[state, action, s_prime]
                        action_value += transition_prob * (reward + self.gamma * V[s_prime])
        ...
        for state in range(self.state_dim):
            ...
            for action in range(self.action_dim):
                ...
                for s_prime in range(self.state_dim):
                    transition_prob = self.mdp.P[state, action, s_prime]
                    reward = self.mdp.R[state, action, s_prime]
                    total_value += transition_prob * (reward + self.gamma * V[s_prime])
            ...
            for state in range(self.state_dim):
                ...
                for action in range(self.action_dim):
                    for s_prime in range(self.state_dim):
                        transition_prob = self.mdp.P[state, action, s_prime]
                        reward = self.mdp.R[state, action, s_prime]
                        state_value += policy[state, action] * transition_prob * (reward + self.gamma * V[s_prime])
                V[state] = state_value
                delta = max(delta, abs(v - V[state]))
            ...
            for state in range(self.state_dim):
                ...
                for action in range(self.action_dim):
                    for s_prime in range(self.state_dim):
                        transition_prob = self.mdp.P[state, action, s_prime]
                        reward = self.mdp.R[state, action, s_prime]
                        action_values[action] += transition_prob * (reward + self.gamma * V[s_prime])
